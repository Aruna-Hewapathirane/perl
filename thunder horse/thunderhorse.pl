...
my $boss_pixbuf   = Gtk3::Gdk::Pixbuf->new_from_file_at_scale("thunderhorse.png", $boss->{width}, $boss->{height}, FALSE);
...
$window->set_title("Thunder Horse");
